...
**Network**
- [x] Public IP (공인 IP)
- [x] Load Balancer (로드밸런서)
- [x] Target Group (타깃 그룹)
- [x] VPC
- [x] Subnet (서브넷)
- [x] NAT Gateway
- [x] VPC Peering
- [x] Network ACL
- [x] Route Table (라우트 테이블)
- [x] Access Control Group (ACG)

**Kubernetes**
- [x] NKS Cluster (Ncloud Kubernetes Service 클러스터)
